...
public class Robustess_detector {
	...
	{// prend en parametre la liste de mis. puis cré un graph specifique de test pour
	...
	{ // cette methode permet de voir si il existe un cheminement d'arrete le menant
		...
		for (Node fut_n : list)
		{
			...
			System.out.println("dans Robustess_detector.isLinked, node n'appatient pas a list");
		}
